    ...
    <section id="protocol" className="relative py-32 border-t border-border">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <SectionHeader
          ...
          intro="Astro collapses entitlement, metering, and settlement into a single primitive. Every resource declares its price. Every caller — human or machine — pays in the same flow that grants access."
        />
...
support.handle(disputes)`}</pre>
          ...
          <div className="rounded-2xl border border-accent/30 bg-surface/60 p-8 accent-glow">
            <div className="text-[11px] font-mono uppercase tracking-[0.18em] text-accent mb-6">With Astro</div>
            <pre className="font-mono text-[12.5px] leading-relaxed text-foreground overflow-x-auto">{`astro.serve({
  resource: "/infer",
  price:    "0.0021 USDC",
  scope:    "inference.gpt",
  settle:   "ethereum"
...
// in one round-trip`}</pre>
        ...
        <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            ["Composable", "Settle in any token, on any chain Astro routes."],
