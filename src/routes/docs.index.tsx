...
const TOC = [
  ...
  { id: "what", label: "What Astro is" },
  { id: "what-not", label: "What Astro isn't" },
  ...
  return (
    <DocsLayout onThisPage={TOC}>
      ...
      <DocSection id="who" title="Who it's for">
        <p>Astro is shaped by — and aimed at — three groups of builders:</p>
        ...
        <p>
          If you ever wanted to charge two cents for an inference, half a cent for a database lookup, or a tenth of a cent for a webhook delivery — and didn't because the billing infrastructure cost more than the revenue — Astro was built for you.
        </p>
      </DocSection>
    ...
    return ctx.respond(result, { receipt: ctx.payment.txHash });
      ...
      <DocSection id="structure" title="How these docs are organized">
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          <li><strong>Clients</strong> — SDK clients and agent commerce. How to call Astro endpoints from apps, services, and autonomous agents.</li>
