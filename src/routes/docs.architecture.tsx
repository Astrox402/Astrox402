...
export const Route = createFileRoute("/docs/architecture")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "How the Astro SDK, verifier, settlement contracts, and indexer fit together to deliver sub-second paid API calls on Ethereum." },
